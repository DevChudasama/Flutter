...
import 'package:ticket_api/screen2.dart';
import 'package:ticket_api/CustomWidget/deals.dart';
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${jsonDecode(snapshot.data!.body.toString())[0]['UserName'].toString()}👋",
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                '${jsonDecode(snapshot.data!.body.toString())[0]['From'].toString()} (DPO)',
                                                style: const TextStyle(
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                '${jsonDecode(snapshot.data!.body.toString())[0]['To'].toString()} (DPS)',
                                                style: const TextStyle(
                                                  fontWeight: FontWeight.w600,
                                                  fontSize: 17,
                                                ),
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 10),
                                      Text(
                                        '${jsonDecode(snapshot.data!.body.toString())[0]['Pass'].toString()} Passenger,Economy',
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16,
                                        ),
